        ...
        <>
            <section className='relative py-20 max-w-6xl mx-auto pb-10 overflow-hidden'>
                <div className="text-center  pb-10 border-b">
                    ...
                    <p className='md:text-2xl text-xl  tracking-wide font-extralight md:w-[68%] pt-10  mx-auto text-center'>Our team brings developers, designers, strategists, and analysts together to craft seamless digital experiences. We don’t cut corners - every product is built with precision, staying true to its original vision. </p>
                </div>
            </section>
            <ServiceCard/>
